...
<div class="container">
     <div class="copyright-txt">
		...
		<?php } ?>
        <?php bloginfo('name'); ?> <?php esc_html_e('Theme By ','skt-mosque');?>
        
        <a href="<?php echo esc_url('https://www.sktthemes.org/shop/free-islamic-centre-wordpress-theme/');?>" target="_blank">
        <?php esc_html_e('SKT Mosque','skt-mosque'); ?>
        </a>
        </div>
     <div class="clear"></div>
</div>           
